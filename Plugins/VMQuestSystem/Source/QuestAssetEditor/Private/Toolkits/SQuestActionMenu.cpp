...
void SQuestActionMenu::CollectAllActions(FGraphActionListBuilderBase& OutAllActions)
{
...
void SQuestActionMenu::OnActionSelected(const TArray<TSharedPtr<FEdGraphSchemaAction>>& SelectedAction, ESelectInfo::Type InSelectionType)
{
	if (!IsValid(Graph))
	{
		return;
